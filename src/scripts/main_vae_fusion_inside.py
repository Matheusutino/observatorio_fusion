"""
Script principal para experimentos com VAE com fusão interna.
...
from src.core.experiments.phases_vae_fusion_inside import (
    run_phase1_vae_fusion_inside,
...
# ===========================================================================
# CONFIGURAÇÕES ESPECÍFICAS PARA VAE FUSION INSIDE
# ===========================================================================
...
def main():
    """Executa o pipeline completo de experimentos com VAEFusionInside."""
    model_name = "vae_fusion_inside"
    ...
    # ========================================================================
    df_phase1, histories_p1, repr_p1 = run_phase1_vae_fusion_inside(
        emb_prod,
        emb_tema,
        y,
        VAEFusionInside,
    ...
    # ========================================================================
    df_phase2, histories_p2, repr_p2 = run_phase2_vae_fusion_inside(
        emb_prod,
        emb_tema,
        y,
        VAEFusionInside,
    ...
    # ========================================================================
    _df_phase3, histories_p3, repr_p3 = run_phase3_vae_fusion_inside(
        df,
        y,
        VAEFusionInside,
        model_kwargs,
