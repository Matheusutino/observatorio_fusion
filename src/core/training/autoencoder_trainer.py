"""
Trainer específico para Autoencoder com dual loss.
"""
import torch
...
class AutoencoderTrainer:
    """
    Trainer para Autoencoder com dual loss: reconstruction + classification.
    ...
    def __init__(
        ...
        ----------
        model : nn.Module
            Modelo Autoencoder a ser treinado.
        criterion_class : nn.Module
    ...
    def train_epoch(self, loader: DataLoader) -> tuple[float, float, float]:
        ...
        for X_batch, y_batch in loader:
            ...
            # Forward pass
            logits, reconstruction = self.model(X_batch)
